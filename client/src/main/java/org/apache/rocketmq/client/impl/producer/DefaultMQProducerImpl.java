...
public class DefaultMQProducerImpl implements MQProducerInner {
        ...
        Runnable request = new Runnable() {
            ...
            public void run() {
                ...
                if (transactionCheckListener != null || transactionListener != null) {
                    ...
                    try {
                        //transactionCheckListener优先级高一点
            ...
            private void processTransactionState(
                ...
                //得到改消息的事务状态后 想broker发送EndTransaction请求
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        if (null == brokerAddr) {
            //地址不存在 从nameserver更新topic信息后再重新获取
    ...
    public TransactionSendResult sendMessageInTransaction(final Message msg,
        ...
        throws MQClientException {
        //获取TransactionListener 里面封装了事务逻辑 和 回查逻辑
        TransactionListener transactionListener = getCheckListener();
        //localTransactionExecuter和transactionListener必须有一个
        //localTransactionExecuter兼容历史版本
        ...
        try {
            //这里会根据本地事务结果 来决定Commit还是rollback
